...
export default function propertyDetails({ propertyDetails: { price, rentFrequency, rooms, title, baths, area, agency, isVerified, description, type, purpose, furnishingStatus, amenities, photos } }){
  return(
    <Box mWidth="1000px" p="4" margin="auto">
      ...
      <Box marginTop='2'>
        <Text fontSize='lg' marginBottom='2' marginLeft='5' fontWeight='bold'>{title}</Text>
        <Text lineHeight='2' color='gray.600' marginLeft='5'>{description}</Text>
      </Box>
